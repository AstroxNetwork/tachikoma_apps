...
export class ElectrumApi implements ElectrumApiInterface {
  ...
  _send = async (
    ...
    if (
      this.provider instanceof HttpProvider &&
      ...
      const result = await this.provider!.sendServer(
        `/${method}${paramstring}`,
        payload!,
        undefined
      );
  ...
  public async atomicalsGetLocation(
  ...
  public async atomicalsGetStateHistory(
    atomicalAliasOrId: string | number
  ): Promise<any> {
    const p = new Promise((resolve, reject) => {
  ...
  public async atomicalsGetState(
    ...
    const p = new Promise((resolve, reject) => {
      this._send("blockchain.atomicals.get_state_by_path", [
        atomicalAliasOrId,
        path,
        verbose ? 1 : 0,
      ])
  ...
  public async atomicalsGetEventHistory(
    atomicalAliasOrId: string | number
  ): Promise<any> {
    const p = new Promise((resolve, reject) => {
  ...
  public async atomicalsGetTxHistory(
    atomicalAliasOrId: string | number
  ): Promise<any> {
    const p = new Promise((resolve, reject) => {
  ...
  public async atomicalsByScripthash(
    scripthash: string,
    verbose = true
  ): Promise<any> {
    const p = new Promise((resolve, reject) => {
  ...
  public async atomicalsGetRealmInfo(
    realmOrSubRealm: string,
    verbose?: boolean
  ): Promise<any> {
    const p = new Promise((resolve, reject) => {
      this._send("blockchain.atomicals.get_realm_info", [
        realmOrSubRealm,
        verbose ? 1 : 0,
      ])
        .then(function (result: any) {
  ...
  public async atomicalsFindTickers(
    prefix: string | null,
    asc?: boolean
  ): Promise<any> {
    const p = new Promise((resolve, reject) => {
  ...
  public async atomicalsFindRealms(
    prefix: string | null,
    asc?: boolean
  ): Promise<any> {
    const p = new Promise((resolve, reject) => {
